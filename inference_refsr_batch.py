...
def parse_args() -> Namespace:
    ...
    parser.add_argument(
        "--config",
        default="/content/CRefDiff_Pandala_v2/configs/model/refsr_dino.yaml",
        type=str,
        help="model config path",
    )
    parser.add_argument(
        "--val_config", type=str, default="/content/CRefDiff_Pandala_v2/configs/dataset/reference_sr_test.yaml"
    )
    parser.add_argument(
        "--output",
        type=str,
